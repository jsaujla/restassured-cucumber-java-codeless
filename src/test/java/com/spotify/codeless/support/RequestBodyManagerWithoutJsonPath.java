 ...
 * @deprecated This class is deprecated. Use RequestBodyManager instead.
 */
@Deprecated
public class RequestBodyManagerWithoutJsonPath {

    /**
     * Logger object for logging purposes. It's declared as final because it's a constant.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(RequestBodyManagerWithoutJsonPath.class);
